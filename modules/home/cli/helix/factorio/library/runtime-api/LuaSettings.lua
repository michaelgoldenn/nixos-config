...
---@class LuaSettings:LuaObject.base
---@
---
...
---
---Individual settings can be changed by overwriting their [ModSetting](https://lua-api.factorio.com/latest/concepts/ModSetting.html) table. Mods can only change their own settings. Using the in-game console, all player settings can be changed.
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaSettings.html#player_default)
---@field player_default PlayerModSettings
---@
---
...
---@field startup StartupModSettings
---@
---
settings={
...
---
---Even though this attribute is a getter, individual settings can be changed by overwriting their [ModSetting](https://lua-api.factorio.com/latest/concepts/ModSetting.html) table. Mods can only change their own settings. Using the in-game console, all player settings can be changed.
---
---### Example
---
---```
