...
---@field object_name "LuaDeciderCombinatorControlBehavior"
---@
---
...
---@param index? uint32 Index to insert new condition at. If not specified, appends to the end.
add_condition = function(condition, index) end;
---Adds a new else-output.
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaDeciderCombinatorControlBehavior.html#add_else_output)
---@param output DeciderCombinatorOutput New else-output to insert.
---@param index? uint32 Index to insert new else-output at. If not specified, appends to the end.
add_else_output = function(output, index) end;
---Adds a new output.
---
...
---@param index? uint32 Index to insert new output at. If not specified, appends to the end.
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaDeciderCombinatorControlBehavior.html#get_else_output)
---@param index uint32 Index of else-output to get.
---@return DeciderCombinatorOutput 
get_else_output = function(index) end;
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaDeciderCombinatorControlBehavior.html#remove_else_output)
---@param index uint32 Index of else-output to remove.
remove_else_output = function(index) end;
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaDeciderCombinatorControlBehavior.html#set_else_output)
---@param index uint32 Index of else-output to modify.
---@param output DeciderCombinatorOutput Data to set selected else-output to.
set_else_output = function(index, output) end;
