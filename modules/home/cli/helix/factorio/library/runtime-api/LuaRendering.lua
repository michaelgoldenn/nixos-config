...
do
---@class (exact) LuaRendering.draw_animation_param
---@
---
...
do
---@class (exact) LuaRendering.draw_arc_param
---@
---
---@field color Color
---@
...
do
---@class (exact) LuaRendering.draw_circle_param
---@
---
---@field color Color
---@
...
do
---@class (exact) LuaRendering.draw_light_param
---@
---
...
do
---@class (exact) LuaRendering.draw_line_param
---@
---
---@field color Color
---@
...
do
---@class (exact) LuaRendering.draw_polygon_param
---@
---
---@field color Color
---@
...
do
---@class (exact) LuaRendering.draw_rectangle_param
---@
---
---@field color Color
---@
...
do
---@class (exact) LuaRendering.draw_sprite_param
---@
---
---@field sprite SpritePath
---@
...
do
---@class (exact) LuaRendering.draw_text_param
---@
---
---The text to display.
...
---@class LuaRendering:LuaObject.base
---@
---
...
---@field object_name "LuaRendering"
---@
---
rendering={
...
---Create a gradient light which is not occluded by any sprites. It is rendered at lower resolution, so it takes less GPU power. The same technique is used for lights drawn by [LightDefinition](https://lua-api.factorio.com/latest/types/LightDefinition.html).
---
