...
do
---@class (exact) LuaFlowStatistics.get_flow_count_param
---@
---
---The prototype ID.
---@field name FlowStatisticsID
---@
---
...
---@class LuaFlowStatistics:LuaObject.base
---@
---
---A mapping of quality name to a list of current tick input samples indexed by prototype name.
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaFlowStatistics.html#current_input_quality_samples)
---@field current_input_quality_samples table<string,table<string,double>>
---@
---
---A mapping of quality name to a list of current tick output samples indexed by prototype name.
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaFlowStatistics.html#current_output_quality_samples)
---@field current_output_quality_samples table<string,table<string,double>>
---@
---
...
---@field input_counts table<string,(uint64)|(double)>
---@
---
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaFlowStatistics.html#input_quality_counts)
---@field input_quality_counts table<string,table<string,(uint64)|(double)>>
---@
---
...
---@field object_name "LuaFlowStatistics"
---@
---
...
---@field output_counts table<string,(uint64)|(double)>
---@
---
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaFlowStatistics.html#output_quality_counts)
---@field output_quality_counts table<string,table<string,(uint64)|(double)>>
---@
---
...
---@field storage_counts table<string,(uint64)|(double)>
---@
---
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaFlowStatistics.html#storage_quality_counts)
---@field storage_quality_counts table<string,table<string,(uint64)|(double)>>
---@
---
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaFlowStatistics.html#get_current_input_sample)
---@param id FlowStatisticsID The prototype ID.
---@return double 
get_current_input_sample = function(id) end;
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaFlowStatistics.html#get_current_output_sample)
---@param id FlowStatisticsID The prototype ID.
---@return double 
get_current_output_sample = function(id) end;
...
---@param id FlowStatisticsID The prototype ID.
---@return (uint64)|(double) 
get_storage_count = function(id) end;
...
on_flow = function(id, count) end;
---Sets the current-tick input sample for a given prototype.
---
---These values get merged into the input counts at the end of the tick.
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaFlowStatistics.html#set_current_input_sample)
---@param id FlowStatisticsID The prototype ID.
---@param count double The new count.
set_current_input_sample = function(id, count) end;
---Sets the current-tick output sample for a given prototype.
---
---These values get merged into the output counts at the end of the tick.
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaFlowStatistics.html#set_current_output_sample)
---@param id FlowStatisticsID The prototype ID.
---@param count double The new count.
set_current_output_sample = function(id, count) end;
...
---@param id FlowStatisticsID The prototype ID.
---@param count (uint64)|(double) The new count. The type depends on the instance of the statistics.
set_storage_count = function(id, count) end;
}
end
