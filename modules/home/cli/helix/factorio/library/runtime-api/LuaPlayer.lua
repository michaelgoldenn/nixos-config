...
do
---@class (exact) LuaPlayer.stack_transfers_param
---@
---
---The inventory to transfer from.
---@field source_inventory LuaInventory
---@
---
...
---@
---
---@field target (LuaInventory)|(LuaEntity)|(LuaPlayer)|(LuaItem)|(LuaItemStack)|(LuaEquipment)
---@
---
---The type of transfer to perform. Only stack\_transfer, stack\_split, inventory\_transfer, and inventory\_split can be used.
---@field transfer_type defines.inventory_actions
---@
---
...
---@field check_for_invalid_armor_removal? boolean
---@
---
...
---@field notify_if_invalid_armor_removal? boolean
---@
---
local LuaPlayer_stack_transfers_param={
}
end
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaPlayer.html#current_music)
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaPlayer.html#disable_space_map)
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaPlayer.html#editor_settings)
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaPlayer.html#hide_locked_prototypes_in_factoriopedia)
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaPlayer.html#quick_bar_width)
---@field quick_bar_width uint8
---@
---
...
---
---This can be set at any time however it is best to set it during the [defines.events.on\_player\_died](https://lua-api.factorio.com/latest/defines.html#defines.events.on_player_died) event.
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaPlayer.html#respawn_quality)
---@field respawn_quality? QualityID
---@
---
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaPlayer.html#saved_logistic_filters)
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaPlayer.html#toggle_menu_leaves_remote_view)
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaPlayer.html#clear_pins)
clear_pins = function() end;
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaPlayer.html#cursor_split)
---@param inventory LuaInventory 
---@param index uint32 
---@return boolean  #If the action succeeded.
cursor_split = function(inventory, index) end;
---Performs the cursor transfer action on the given inventory at the given index as if the player did it.
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaPlayer.html#cursor_transfer)
---@param inventory LuaInventory 
---@param index uint32 
---@return boolean  #If the action succeeded.
cursor_transfer = function(inventory, index) end;
...
get_alerts = function(filter) end;
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaPlayer.html#get_pins)
---@return (LuaPin)[] 
get_pins = function() end;
...
---@param page_index uint8 
---@param slot_index uint8 
---@return QuickBarSlot? 
get_quick_bar_slot = function(page_index, slot_index) end;
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaPlayer.html#play_music)
...
---@param filter AlertFilter 
remove_alert = function(filter) end;
---Requests a translation for the given localised string. The [on\_string\_translated](https://lua-api.factorio.com/latest/events.html#on_string_translated) event will be fired with the results.
---
---If this player is not connected (see [LuaPlayer::connected](https://lua-api.factorio.com/latest/classes/LuaPlayer.html#connected)) the translation will happen next time they connect.
---
---**Events:**
---
...
---Requests translation for the given set of localised strings. A [on\_string\_translated](https://lua-api.factorio.com/latest/events.html#on_string_translated) event will be fired for each string with the results.
---
---If this player is not connected (see [LuaPlayer::connected](https://lua-api.factorio.com/latest/classes/LuaPlayer.html#connected)) the translation will happen next time they connect.
---
---**Events:**
...
---@param page_index uint8 
---@param slot_index uint8 
---@param filter (LuaItemStack)|(ItemWithQualityID)|(QuickBarSlot)|(nil) The filter or `nil` to clear it.
set_quick_bar_slot = function(page_index, slot_index, filter) end;
...
---
---This can be paired with [defines.events.on\_gui\_inventory\_action](https://lua-api.factorio.com/latest/defines.html#defines.events.on_gui_inventory_action) to make custom inventory GUIs that act like builtin inventories.
---
---Reach distance is ignored and can be checked using [LuaControl::can\_reach\_entity](https://lua-api.factorio.com/latest/classes/LuaControl.html#can_reach_entity) if wanted.
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaPlayer.html#stack_transfers)
---@param param LuaPlayer.stack_transfers_param 
---@return (ItemWithQualityCount)[]?  #List of all items moved. This will be `nil` if the transfer was blocked.
stack_transfers = function(param) end;
