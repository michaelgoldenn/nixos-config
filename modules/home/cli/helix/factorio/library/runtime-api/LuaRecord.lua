...
do
---@class (exact) LuaRecord.build_blueprint_param
---@
---
---Surface to build on
...
---@
---
---The player to use if any. If provided [defines.events.on\_built\_entity](https://lua-api.factorio.com/latest/defines.html#defines.events.on_built_entity) will be fired for new entities and [defines.events.on\_blueprint\_settings\_pasted](https://lua-api.factorio.com/latest/defines.html#defines.events.on_blueprint_settings_pasted) will be fired for existing entities that are updated.
---@field by_player? PlayerIdentification
---@
---
---If true; [defines.events.script\_raised\_built](https://lua-api.factorio.com/latest/defines.html#defines.events.script_raised_built) will be fired for new entities and [defines.events.on\_blueprint\_settings\_pasted](https://lua-api.factorio.com/latest/defines.html#defines.events.on_blueprint_settings_pasted) will be fired for existing entities that are updated. Note: this is ignored if by\_player is provided.
...
do
---@class (exact) LuaRecord.cancel_deconstruct_area_param
---@
---
...
do
---@class (exact) LuaRecord.create_blueprint_param
---@
---
...
do
---@class (exact) LuaRecord.deconstruct_area_param
---@
---
...
---@class LuaRecord:LuaObject.base
---@
---
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaRecord.html#blueprint_description)
---
---*Can only be used if this is BlueprintRecord or BlueprintBookRecord*
...
---@
---
---The contents of this BlueprintBookRecord. This is sparse array - it may have gaps, so using `#` will not be reliable. Use [LuaRecord::contents\_size](https://lua-api.factorio.com/latest/classes/LuaRecord.html#contents_size) or `pairs()` to iterate this table.
---
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaRecord.html#contents_size)
---
---*Can only be used if this is BlueprintBookRecord*
...
---@field entity_filter_count uint32
---@
---
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaRecord.html#is_preview)
---@field is_preview boolean
---@
---
---The current label for this record, if any.
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaRecord.html#label)
---@field label? string
---@
---
...
---@field mapper_count uint32
---@
---
---The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaRecord.html#object_name)
---@field object_name "LuaRecord"
---@
---
---The description for this deconstruction planner or upgrade planner.
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaRecord.html#planner_description)
---
---*Can only be used if this is DeconstructionRecord or UpgradeRecord*
---@field planner_description string
---@
---
---The preview icons for this record.
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaRecord.html#preview_icons)
...
---
---*Can only be used if this is DeconstructionRecord*
---@field tile_filter_count uint32
---@
---
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaRecord.html#export_record)
---@return string 
export_record = function() end;
...
---*Can only be used if this is BlueprintBookRecord*
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaRecord.html#get_active_index)
---@param player PlayerIdentification 
---@return uint32 
get_active_index = function(player) end;
...
---*Can only be used if this is BlueprintBookRecord*
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaRecord.html#get_selected_record)
---@param player PlayerIdentification 
---@return LuaRecord? 
get_selected_record = function(player) end;
