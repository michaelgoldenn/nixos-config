...
---@
---
---Is this blueprint record a preview? A preview record must be synced by the player before entity and tile data can be read. This property is deprecated in favor of [LuaRecord::is\_preview](https://lua-api.factorio.com/latest/classes/LuaRecord.html#is_preview) and should not be used.
---
