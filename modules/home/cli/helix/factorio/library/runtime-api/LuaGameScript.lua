...
do
---@class (exact) LuaGameScript.get_vehicles_param
---@
---
...
do
---@class (exact) LuaGameScript.set_game_state_param
---@
---
...
do
---@class (exact) LuaGameScript.set_lose_ending_info_param
---@
---
...
do
---@class (exact) LuaGameScript.set_win_ending_info_param
---@
---
---@field title LocalisedString
---@
...
do
---@class (exact) LuaGameScript.show_message_dialog_param
---@
---
...
do
---@class (exact) LuaGameScript.take_screenshot_param
---@
---
...
do
---@class (exact) LuaGameScript.take_technology_screenshot_param
---@
---
...
---@class LuaGameScript:LuaObject.base
---@
---
---Whether players who are not [admins](https://lua-api.factorio.com/latest/classes/LuaPlayer.html#admin) can access all debug settings. Set this to false to disallow access to most debug settings for non-admins.
---
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaGameScript.html#allow_debug_settings)
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaGameScript.html#allow_tip_activation)
...
---@field backer_names LuaCustomTable<uint32, string>
---@
---
...
---@field forces LuaCustomTable<(uint32)|(string), LuaForce>
---@
---
...
---@field object_name "LuaGameScript"
---@
---
...
---@field players LuaCustomTable<(uint32)|(string), LuaPlayer>
---@
---
...
---@field surfaces LuaCustomTable<(uint32)|(string), LuaSurface>
---@
---
...
---@param allow_in_replay? boolean Whether to save the auto-save even during replay playback. Defaults to `false`
auto_save = function(name, allow_in_replay) end;
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaGameScript.html#delete_blueprint_library)
---@param player PlayerIdentification 
delete_blueprint_library = function(player) end;
...
---Returns entity with a specified unit number or nil if entity with such number was not found or prototype does not have [EntityPrototypeFlags::get-by-unit-number](https://lua-api.factorio.com/latest/types/EntityPrototypeFlags.html%23get_by_unit_number#get_by_unit_number) flag set.
---
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaGameScript.html#play_music)
