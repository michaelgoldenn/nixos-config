...
---@alias BlueprintEntity (BlueprintEntity.accumulator)|(BlueprintEntity.agricultural_tower)|(BlueprintEntity.ammo_turret)|(BlueprintEntity.arithmetic_combinator)|(BlueprintEntity.artillery_turret)|(BlueprintEntity.artillery_wagon)|(BlueprintEntity.assembling_machine)|(BlueprintEntity.asteroid_collector)|(BlueprintEntity.car)|(BlueprintEntity.cargo_landing_pad)|(BlueprintEntity.cargo_wagon)|(BlueprintEntity.constant_combinator)|(BlueprintEntity.container)|(BlueprintEntity.decider_combinator)|(BlueprintEntity.display_panel)|(BlueprintEntity.electric_energy_interface)|(BlueprintEntity.electric_turret)|(BlueprintEntity.fluid_turret)|(BlueprintEntity.fluid_wagon)|(BlueprintEntity.furnace)|(BlueprintEntity.heat_interface)|(BlueprintEntity.infinity_cargo_wagon)|(BlueprintEntity.infinity_container)|(BlueprintEntity.infinity_pipe)|(BlueprintEntity.inserter)|(BlueprintEntity.lamp)|(BlueprintEntity.lane_splitter)|(BlueprintEntity.linked_belt)|(BlueprintEntity.linked_container)|(BlueprintEntity.loader)|(BlueprintEntity.loader_1x1)|(BlueprintEntity.locomotive)|(BlueprintEntity.logistic_container)|(BlueprintEntity.mining_drill)|(BlueprintEntity.power_switch)|(BlueprintEntity.programmable_speaker)|(BlueprintEntity.proxy_container)|(BlueprintEntity.pump)|(BlueprintEntity.rail_chain_signal)|(BlueprintEntity.rail_signal)|(BlueprintEntity.reactor)|(BlueprintEntity.roboport)|(BlueprintEntity.rocket_silo)|(BlueprintEntity.selector_combinator)|(BlueprintEntity.space_platform_hub)|(BlueprintEntity.spider_vehicle)|(BlueprintEntity.splitter)|(BlueprintEntity.storage_tank)|(BlueprintEntity.train_stop)|(BlueprintEntity.transport_belt)|(BlueprintEntity.turret)|(BlueprintEntity.underground_belt)|(BlueprintEntity.valve)|(BlueprintEntity.wall)|(BlueprintEntity.base)
...
---@field circuit_mode_of_operation? defines.control_behavior.cargo_landing_pad.exclusive_mode
---@
---
...
do
---@class (exact) EntityPrototypeFilter.build_base_evolution_requirement:EntityPrototypeFilter.base
---@
---
---@field filter "build-base-evolution-requirement"
---@
---
...
do
---@class (exact) FluidBoxFilterSpec
---@
---
---Fluid prototype name of the filtered fluid.
---@field name string
...
---[View Documentation](https://lua-api.factorio.com/latest/concepts/InventoryIndex.html)
...
---
---The condition to filter on.
---@field filter ("tool")|("mergeable")|("hidden")|("hidden-in-factoriopedia")|("is-parameter")|("item-with-inventory")|("selection-tool")|("item-with-label")|("has-rocket-launch-products")|("fuel")|("place-result")|("burnt-result")|("place-as-tile")|("placed-as-equipment-result")|("plant-result")|("spoil-result")|("name")|("type")|("flag")|("subgroup")|("fuel-category")|("stack-size")|("fuel-value")|("fuel-acceleration-multiplier")|("fuel-top-speed-multiplier")|("fuel-emissions-multiplier")
---@
---
---How to combine this with the previous filter. Defaults to `"or"`. When evaluating the filters, `"and"` has higher precedence than `"or"`.
---@field mode? ("or")|("and")
...
---
---Defaults to `send_contents`.
---@field circuit_mode_of_operation? defines.control_behavior.logistic_container.exclusive_mode
---@
---
...
---
---Quality values are multiplied by [LuaQualityPrototype::next\_probability](https://lua-api.factorio.com/latest/classes/LuaQualityPrototype.html#next_probability). For example, if a module's quality effect is 0.2 and the current quality's next\_probability is 0.1, then the chance to get the next quality item is 2%.
---
---[View Documentation](https://lua-api.factorio.com/latest/concepts/ModuleEffectValue.html)
---@alias ModuleEffectValue float

do
---@class (exact) ModuleEffects
---@
---
...
---A set of flags. Active flags are in the dictionary as `true`, while inactive flags aren't present at all.
---
---To write to this, use an array\[[string](https://lua-api.factorio.com/latest/concepts/string.html)] of the mouse buttons that should be possible to use with on button. The flag `"left-and-right"` can also be set, which will set `"left"` and `"right"` to `true`.
---
---[View Documentation](https://lua-api.factorio.com/latest/concepts/MouseButtonFlags.html)
---@class (exact) MouseButtonFlags
---@
---
---@field ["left"] true
---@
...
do
---@class (exact) PowerSwitchBlueprintControlBehavior
---@
---
---Defaults to `false`.
---@field circuit_enabled? boolean
...
---@
---
local PowerSwitchBlueprintControlBehavior={
}
end
...
---
---Defaults to `false`.
---@field read_burner_fuel? boolean
---@
---
---Defaults to `false`.
...
---@alias SelectorCombinatorParameters (SelectorCombinatorParameters.count)|(SelectorCombinatorParameters.quality_filter)|(SelectorCombinatorParameters.quality_transfer)|(SelectorCombinatorParameters.random)|(SelectorCombinatorParameters.select)
...
do
---@class (exact) SteeringMapSetting
---@
---
...
do
---@class (exact) SteeringMapSettings
---@
---
...
do
---@class (exact) StorageTankBlueprintControlBehavior
---@
---
---Defaults to `true`.
---@field read_contents? boolean
---@
---
local StorageTankBlueprintControlBehavior={
}
end
