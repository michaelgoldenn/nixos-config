...
---
---*Can only be used if this is LuaButtonStyle or LuaLabelStyle*
...
---```
---@field column_alignments LuaCustomTable<uint32, Alignment>
---@
---
...
---
---*Can only be used if this is LuaButtonStyle, LuaTabStyle, LuaLabelStyle or LuaTextBoxStyle*
...
---@
---
---Gui of the [LuaGuiElement](https://lua-api.factorio.com/latest/classes/LuaGuiElement.html) of this style.
---
...
---
---*Can only be used if this is LuaLabelStyle or LuaTextBoxStyle*
...
---
local LuaStyle={
---Gets the given sub-style of this style if it exists. See [StyleSpecification](https://lua-api.factorio.com/latest/types/StyleSpecification.html) types for what sub styles are usable.
---
---Note: when creating sub-styles they have no set values and have the parent set to the styles top-level default.
---
---Note: when the parent [LuaGuiElement::style](https://lua-api.factorio.com/latest/classes/LuaGuiElement.html#style) is directly changed (element.style = "new\_style") any sub-styles will be invalidated.
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaStyle.html#get_style)
---@param style_name string The style to get.
---@param create? boolean If true, and the given sub-style is valid - it will be created if it does not exist. Defaults to `false`.
---@return LuaStyle? 
get_style = function(style_name, create) end;
}
end
