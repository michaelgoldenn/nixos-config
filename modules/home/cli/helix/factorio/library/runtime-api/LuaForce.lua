...
do
---@class (exact) LuaForce.create_space_platform_param
---@
---
...
---@field starter_pack ItemWithQualityID
---@
---
...
---@field belt_stack_size_bonus uint32
---@
---
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaForce.html#cargo_landing_pad_limit)
---@field cargo_landing_pad_limit uint32
---@
---
...
---@field character_inventory_slots_bonus uint32
---@
---
...
---@
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaForce.html#circuit_network_enabled)
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaForce.html#cliff_deconstruction_enabled)
...
---@field deconstruction_time_to_live uint32
---@
---
...
---@
---
---Maximum distance between cargo bay from its connected cargo landing pad that allows unloading. Only relevant for cargo bays that have both [LuaEntityPrototype::allow\_unloading](https://lua-api.factorio.com/latest/classes/LuaEntityPrototype.html#allow_unloading) and [LuaEntityPrototype::use\_unloading\_distance\_limit](https://lua-api.factorio.com/latest/classes/LuaEntityPrototype.html#use_unloading_distance_limit) set to `true`.
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaForce.html#max_cargo_bay_unloading_distance)
---@field max_cargo_bay_unloading_distance double
---@
---
...
---@field maximum_following_robot_count uint32
---@
---
...
---@
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaForce.html#mining_with_fluid)
...
---@field platforms table<uint32,LuaSpacePlatform>
---@
---
...
---@
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaForce.html#rail_planner_allow_elevated_rails)
---@field rail_planner_allow_elevated_rails boolean
---@
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaForce.html#rail_support_on_deep_oil_ocean)
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaForce.html#unlock_logistic_network)
---@field unlock_logistic_network boolean
---@
---
---Whether traveling to space platforms via rockets is unlocked.
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaForce.html#unlock_travel_to_space_platforms)
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaForce.html#vehicle_logistics)
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaForce.html#add_alert)
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaForce.html#add_custom_alert)
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaForce.html#create_logistic_group)
---@param name string 
---@param type? defines.logistic_group_type Defaults to `defines.logistic_group_type.with_trash`.
create_logistic_group = function(name, type) end;
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaForce.html#delete_logistic_group)
---@param name string 
---@param type? defines.logistic_group_type Defaults to `defines.logistic_group_type.with_trash`.
delete_logistic_group = function(name, type) end;
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaForce.html#get_chunk_chart)
---@param surface SurfaceIdentification 
---@param chunk_position ChunkPosition 
---@return string?  #The raw pixel data.
get_chunk_chart = function(surface, chunk_position) end;
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaForce.html#get_logistic_group)
---@param name string 
---@param type? defines.logistic_group_type Defaults to `defines.logistic_group_type.with_trash`.
---@return LogisticGroup? 
get_logistic_group = function(name, type) end;
---Gets the names of the current logistic groups.
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaForce.html#get_logistic_groups)
---@param type? defines.logistic_group_type Defaults to `defines.logistic_group_type.with_trash`.
---@return (string)[] 
get_logistic_groups = function(type) end;
---Gets the unlockable script state for the given ID.
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaForce.html#get_script_visible)
---@param unlockable UnlockableID 
---@return boolean? 
get_script_visible = function(unlockable) end;
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaForce.html#get_space_platforms)
---@param location SpaceLocationID 
---@return (LuaSpacePlatform)[] 
get_space_platforms = function(location) end;
...
---@return boolean 
is_chunk_charted = function(surface, chunk_position) end;
...
---@param chunk_position ChunkPosition Position of the chunk.
---@return boolean 
is_chunk_requested_for_charting = function(surface, chunk_position) end;
...
---@param chunk_position ChunkPosition 
---@return boolean 
is_chunk_visible = function(surface, chunk_position) end;
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaForce.html#is_visible)
---@param unlockable UnlockableID 
---@return boolean 
is_visible = function(unlockable) end;
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaForce.html#play_music)
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaForce.html#remove_alert)
...
---Load the original versions of technologies from prototypes. Preserves research, enabled and visible\_when\_disabled state of technologies.
---
...
---Trigger the "scripted" [research trigger](https://lua-api.factorio.com/latest/concepts/ResearchTrigger.html) of a technology, researching it. Does nothing if the technology does not have a "scripted" research trigger.
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaForce.html#script_trigger_research)
---@param technology TechnologyID 
script_trigger_research = function(technology) end;
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaForce.html#set_script_visible)
---@param unlockable UnlockableID 
---@param value? boolean 
set_script_visible = function(unlockable, value) end;
...
unchart_chunk = function(chunk_position, surface) end;
