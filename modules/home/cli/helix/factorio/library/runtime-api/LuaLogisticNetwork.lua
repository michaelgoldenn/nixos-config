...
do
---@class (exact) LuaLogisticNetwork.select_drop_point_param
---@
---
...
do
---@class (exact) LuaLogisticNetwork.select_pickup_point_param
---@
---
...
---@class LuaLogisticNetwork:LuaObject.base
---@
---
...
---@field all_construction_robots uint32
---@
---
...
---@field all_logistic_robots uint32
---@
---
...
---@field available_construction_robots uint32
---@
---
...
---@field available_logistic_robots uint32
---@
---
...
---
---[View Documentation](https://lua-api.factorio.com/latest/classes/LuaLogisticNetwork.html#custom_name)
...
---@field object_name "LuaLogisticNetwork"
---@
---
...
---@param count? uint32 Count to check. Defaults to 1.
...
---@param member? ("storage")|("providers") Logistic members to check. If not given, gives item counts for the entire network.
---@return (ItemWithQualityCount)[]  #List of all items in the network.
get_contents = function(member) end;
