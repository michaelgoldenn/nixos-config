...
--$Factorio 2.1.17
--$Generator 2.1.9
--$Section prototype-api/prototypes/ElevatedStraightRailPrototype
...
---
---[View Documentation](https://lua-api.factorio.com/latest/prototypes/ElevatedStraightRailPrototype.html%23name#name)
---@field name string
---@
---
...
---
---[View Documentation](https://lua-api.factorio.com/latest/prototypes/ElevatedStraightRailPrototype.html%23selection_priority#selection_priority)
...
---
---[View Documentation](https://lua-api.factorio.com/latest/prototypes/ElevatedStraightRailPrototype.html%23tall#tall)
---@field tall? boolean
---@
---
...
---@alias ElevatedStraightRailName (string)
