...
---
---Named noise expressions can also be used as [noise variables](https://lua-api.factorio.com/latest/auxiliary/noise-expressions.html) e.g. `var("my-noise-expression")`.
---
