...
--$Factorio 2.1.17
--$Generator 2.1.9
--$Section prototype-api/prototypes/ElevatedCurvedRailAPrototype
...
---
---[View Documentation](https://lua-api.factorio.com/latest/prototypes/ElevatedCurvedRailAPrototype.html%23name#name)
---@field name string
---@
---
...
---
---[View Documentation](https://lua-api.factorio.com/latest/prototypes/ElevatedCurvedRailAPrototype.html%23selection_priority#selection_priority)
...
---
---[View Documentation](https://lua-api.factorio.com/latest/prototypes/ElevatedCurvedRailAPrototype.html%23tall#tall)
---@field tall? boolean
---@
---
...
---@alias ElevatedCurvedRailAName (string)
